...
MUSIC_BOT_NAME = getenv("MUSIC_BOT_NAME", "❰❰𝐂𝐨𝐜𝐤𝐭𝐚𝐢𝐥✘𝐦𝐮𝐬𝐢𝐜❱❱")
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/dark_dairy")
SUPPORT_GROUP = getenv("SUPPORT_GROUP", "https://t.me/venom_world_chatting_club")
